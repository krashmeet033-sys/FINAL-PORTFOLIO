  ...
  return (
    <section id="github" className="py-16 px-4 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col items-center text-center mb-20">
        ...
        <h3 className="text-5xl font-black italic tracking-tighter uppercase mb-4">
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="glass-card p-8 rounded-[40px] border-white/5 overflow-x-auto bg-black/40"
      >
        <img
  src="https://github-readme-activity-graph.vercel.app/graph?username=krashmeet033-sys&theme=github-dark"
